...
public abstract class AbstractC0648d {
    ...
    /* JADX INFO: renamed from: a */
    public static String m1598a(int i3, String str) {
        int[] iArr;
        int[] iArr2;
        int i4;
        int i5;
        ...
        for (int i8 = 0; i8 < length; i8++) {
            int i9 = i3 - 1;
            int iCharAt = cArr[i9] ^ str.charAt(i8);
            while (true) {
                iArr = f1735c;
                iArr2 = f1736d;
                if (i9 <= 0) {
                ...
                if (iCharAt == 0 || (i5 = iArr3[i9]) == 0) {
                    cArr[i9] = cArr[i9 - 1];
                } else {
                    cArr[i9] = (char) (iArr2[(iArr[iCharAt] + iArr[i5]) % 255] ^ cArr[i9 - 1]);
                }
                i9--;
            }
