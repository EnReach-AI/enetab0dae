...
public class StdArraySerializers$BooleanArraySerializer extends ArraySerializerBase<boolean[]> {
    ...
    static {
        ...
        VALUE_TYPE = C1675q.m3772m(Boolean.class);
    }
    ...
    public AbstractC0728s _withResolved(InterfaceC0714e interfaceC0714e, Boolean bool) {
        return new StdArraySerializers$BooleanArraySerializer(this, interfaceC0714e, bool);
    }
    ...
    public void acceptJsonFormatVisitor(InterfaceC1338c interfaceC1338c, AbstractC0721l abstractC0721l) {
        visitArrayFormat(interfaceC1338c, abstractC0721l, EnumC1337b.f4766h);
    }
    ...
    public AbstractC0725p getSchema(AbstractC0709K abstractC0709K, Type type) {
        ...
        c1514vCreateSchemaNode.m3559s("items", createSchemaNode("boolean"));
        return c1514vCreateSchemaNode;
    }

    public StdArraySerializers$BooleanArraySerializer(StdArraySerializers$BooleanArraySerializer stdArraySerializers$BooleanArraySerializer, InterfaceC0714e interfaceC0714e, Boolean bool) {
        super(stdArraySerializers$BooleanArraySerializer, interfaceC0714e, bool);
    }
    ...
    public boolean isEmpty(AbstractC0709K abstractC0709K, boolean[] zArr) {
    ...
    public final void serialize(boolean[] zArr, AbstractC0540h abstractC0540h, AbstractC0709K abstractC0709K) {
        if (zArr.length == 1 && _shouldUnwrapSingle(abstractC0709K)) {
            serializeContents(zArr, abstractC0540h, abstractC0709K);
            return;
        }
        abstractC0540h.mo1119L(zArr);
        serializeContents(zArr, abstractC0540h, abstractC0709K);
        abstractC0540h.mo1142o();
    }

    @Override // com.fasterxml.jackson.databind.ser.std.ArraySerializerBase
    public void serializeContents(boolean[] zArr, AbstractC0540h abstractC0540h, AbstractC0709K abstractC0709K) {
        for (boolean z3 : zArr) {
            abstractC0540h.mo1140m(z3);
        }
    }
}
