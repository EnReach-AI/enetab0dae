...
public class StdArraySerializers$IntArraySerializer extends ArraySerializerBase<int[]> {
    ...
    public AbstractC0728s _withResolved(InterfaceC0714e interfaceC0714e, Boolean bool) {
        return new StdArraySerializers$IntArraySerializer(this, interfaceC0714e, bool);
    }
    ...
    public StdArraySerializers$IntArraySerializer(StdArraySerializers$IntArraySerializer stdArraySerializers$IntArraySerializer, InterfaceC0714e interfaceC0714e, Boolean bool) {
        super(stdArraySerializers$IntArraySerializer, interfaceC0714e, bool);
    }
    ...
    public boolean isEmpty(AbstractC0709K abstractC0709K, int[] iArr) {
    ...
    public final void serialize(int[] iArr, AbstractC0540h abstractC0540h, AbstractC0709K abstractC0709K) {
        if (iArr.length == 1 && _shouldUnwrapSingle(abstractC0709K)) {
            serializeContents(iArr, abstractC0540h, abstractC0709K);
            return;
        }
        int length = iArr.length;
        abstractC0540h.getClass();
        AbstractC0540h.m1107b(iArr.length, length);
        abstractC0540h.mo1119L(iArr);
        for (int i3 : iArr) {
            abstractC0540h.mo1149v(i3);
        }
        abstractC0540h.mo1142o();
    }

    @Override // com.fasterxml.jackson.databind.ser.std.ArraySerializerBase
    public void serializeContents(int[] iArr, AbstractC0540h abstractC0540h, AbstractC0709K abstractC0709K) {
        for (int i3 : iArr) {
            abstractC0540h.mo1149v(i3);
        }
    }
