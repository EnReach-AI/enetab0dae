...
public class StdArraySerializers$LongArraySerializer extends StdArraySerializers$TypedPrimitiveArraySerializer<long[]> {
    ...
    public AbstractC0728s _withResolved(InterfaceC0714e interfaceC0714e, Boolean bool) {
        return new StdArraySerializers$LongArraySerializer(this, interfaceC0714e, bool);
    }
    ...
    public AbstractC0725p getSchema(AbstractC0709K abstractC0709K, Type type) {
        ...
        c1514vCreateSchemaNode.m3559s("items", createSchemaNode("number", true));
        return c1514vCreateSchemaNode;
    }

    public StdArraySerializers$LongArraySerializer(StdArraySerializers$LongArraySerializer stdArraySerializers$LongArraySerializer, InterfaceC0714e interfaceC0714e, Boolean bool) {
        super(stdArraySerializers$LongArraySerializer, interfaceC0714e, bool);
    }
    ...
    public boolean isEmpty(AbstractC0709K abstractC0709K, long[] jArr) {
    ...
    public final void serialize(long[] jArr, AbstractC0540h abstractC0540h, AbstractC0709K abstractC0709K) {
        if (jArr.length == 1 && _shouldUnwrapSingle(abstractC0709K)) {
            serializeContents(jArr, abstractC0540h, abstractC0709K);
            return;
        }
        int length = jArr.length;
        abstractC0540h.getClass();
        AbstractC0540h.m1107b(jArr.length, length);
        abstractC0540h.mo1119L(jArr);
        for (long j2 : jArr) {
            abstractC0540h.mo1150w(j2);
        }
        abstractC0540h.mo1142o();
    }

    @Override // com.fasterxml.jackson.databind.ser.std.ArraySerializerBase
    public void serializeContents(long[] jArr, AbstractC0540h abstractC0540h, AbstractC0709K abstractC0709K) {
        for (long j2 : jArr) {
            abstractC0540h.mo1150w(j2);
        }
    }
