...
public class StdJdkSerializers$AtomicLongSerializer extends StdScalarSerializer<AtomicLong> {
    ...
    public void acceptJsonFormatVisitor(InterfaceC1338c interfaceC1338c, AbstractC0721l abstractC0721l) {
        visitIntFormat(interfaceC1338c, abstractC0721l, EnumC0544l.f1299f);
    }
    ...
    public void serialize(AtomicLong atomicLong, AbstractC0540h abstractC0540h, AbstractC0709K abstractC0709K) {
        abstractC0540h.mo1150w(atomicLong.get());
    }
}
