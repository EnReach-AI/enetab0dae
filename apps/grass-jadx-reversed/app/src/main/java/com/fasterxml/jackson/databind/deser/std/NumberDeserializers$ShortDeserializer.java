...
public class NumberDeserializers$ShortDeserializer extends NumberDeserializers$PrimitiveOrWrapperDeserializer<Short> {
    ...
    public NumberDeserializers$ShortDeserializer(Class<Short> cls, Short sh) {
        super(cls, EnumC1664f.f5894j, sh, (short) 0);
    }

    public Short _parseShort(AbstractC0545m abstractC0545m, AbstractC0718i abstractC0718i) throws C0850b {
        ...
        if (iMo1191f != 6) {
            if (iMo1191f == 7) {
                return Short.valueOf(abstractC0545m.mo1156A());
            }
            if (iMo1191f == 8) {
                EnumC0816b enumC0816b_checkFloatToIntCoercion = _checkFloatToIntCoercion(abstractC0545m, abstractC0718i, this._valueClass);
                return enumC0816b_checkFloatToIntCoercion == enumC0816b2 ? getNullValue(abstractC0718i) : enumC0816b_checkFloatToIntCoercion == enumC0816b ? (Short) getEmptyValue(abstractC0718i) : Short.valueOf(abstractC0545m.mo1156A());
            }
        ...
        if (enumC0816b_checkFromStringCoercion == enumC0816b) {
            return (Short) getEmptyValue(abstractC0718i);
        }
        ...
        try {
            ...
            if (!_shortOverflow(iM1349f)) {
                return Short.valueOf((short) iM1349f);
            }
            abstractC0718i.m1829G(this._valueClass, strTrim, "overflow, value cannot be represented as 16-bit value", new Object[0]);
            throw null;
        } catch (IllegalArgumentException unused) {
            abstractC0718i.m1829G(this._valueClass, strTrim, "not a valid Short value", new Object[0]);
            throw null;
        }
    }
    ...
    public Short deserialize(AbstractC0545m abstractC0545m, AbstractC0718i abstractC0718i) {
        return abstractC0545m.mo1171P() ? Short.valueOf(abstractC0545m.mo1156A()) : this._primitive ? Short.valueOf(_parseShortPrimitive(abstractC0545m, abstractC0718i)) : _parseShort(abstractC0545m, abstractC0718i);
    }
}
