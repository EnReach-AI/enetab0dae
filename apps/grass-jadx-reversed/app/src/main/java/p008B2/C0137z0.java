...
public final class C0137z0 extends AbstractC0095e0 {
    ...
    public final Object mo227a() {
        short[] sArrCopyOf = Arrays.copyOf(this.f352a, this.f353b);
        AbstractC1766e.m3919d("copyOf(this, newSize)", sArrCopyOf);
        return new C1076u(sArrCopyOf);
    }
