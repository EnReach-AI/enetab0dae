module aro-ext-app/core

go 1.24.5

replace github.com/go-gost/x => ./vendor-x

// replace github.com/aro-network/aro-edge-agent/agent => ../../aro-edge-agent/agent
...
require github.com/aro-network/aro-edge-agent/agent v0.0.0-20260209033336-2c9e1d587440
...
require (
	...
	github.com/aro-network/aro-edge-agent/devpage v0.0.0-20260205051827-0660ff8ce203 // indirect
	github.com/aro-network/aro-proxy-worker/x v0.0.0-20260129021610-a2e00bd80c78 // indirect
	...
	github.com/xiaoxiao-1022/go-iperf v0.0.18 // indirect
